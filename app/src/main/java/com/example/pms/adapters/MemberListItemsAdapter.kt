...
open class MemberListItemsAdapter(
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val iv_member_image :ImageView = itemView.findViewById(R.id.iv_member_image)
        val tv_member_name :TextView = itemView.findViewById(R.id.tv_member_name)
        val tv_member_email :TextView = itemView.findViewById(R.id.tv_member_email)
        val iv_selected_member :ImageView = itemView.findViewById(R.id.iv_selected_member)
    }

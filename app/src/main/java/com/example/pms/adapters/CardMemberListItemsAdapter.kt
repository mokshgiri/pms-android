...
open class CardMemberListItemsAdapter(
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val iv_add_member : ImageView = itemView.findViewById(R.id.iv_add_member)
        val iv_selected_member_image : ImageView = itemView.findViewById(R.id.iv_selected_member_image)
    }
}
// END
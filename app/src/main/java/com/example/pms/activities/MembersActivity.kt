...
import com.example.pms.adapters.MemberListItemsAdapter
...
//        setUpMembersList(ArrayList<User>)
    ...
    fun memberDetails(user : User){
        ...
        FirestoreClass().assignMembersToBoard(this, boardDetails, user)
    }
    ...
    private fun dialogSearchMember(){
        ...
        val et_email_search_member : TextView = dialog.findViewById(R.id.et_email_search_member)
        ...
        tv_add.setOnClickListener{
            ...
            if (email.isNotEmpty()){
                ...
                Toast.makeText(this@MembersActivity, "Please enter members email address", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    ...
    fun memberAssignedSuccess(user : User){
        ...
        CurrentAssignedMemberId().memberId = user.id
